...
<head>
    ...
    <title>Nedjma Restaurant | Waiter</title>
    ...
    <script>
        setInterval(
            function(){
                $('#content').load('<?php echo url('datafolder/data6Waiter');?>');
            },500);
...
<body>
    ...
    <nav id="mainavbar" class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(#000407,#00041c);">
     <div class="container">
      <a class="navbar-brand" href="/Waiter"><i class="far fa-star-half text-white"></i>Nedjma</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link active" href="/Waiter">Trafic</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/Waiter/Order">Order</a>
          </li>
          <li class="nav-item">
